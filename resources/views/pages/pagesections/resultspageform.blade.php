<form class="form-element" id="resultspage_form">
    <div class="filter-parent {{ !empty($displayBlock) && ($displayBlock) ? 'd-block' : '' }}">
        <div class="filter container">
                ...
                <div class="select-proximity">
                    <div class="filter-section">
                        ...
                        <div class="filter-section-child">
                            ...
                            @include('components.basic.select', ['showLabel' => true, 'options' => $data['filters']['userRatings'], 'chevronFAClassName' => 'fa-chevron-down black-chevron', 'selectClass' => 'results-page-select highlight', 'placeholder'=>'NHS User Rating', 'name'=>'user_rating', 'resultsLabel' => 'resultsLabel'])
                            <a tabindex="0" data-offset="30px, 40px"
                               class="help-link"
                                @include('components.basic.popover', [
                                'dismissible'   => true,
            ...
            <div class="filter-right d-flex align-items-end justify-content-end">
