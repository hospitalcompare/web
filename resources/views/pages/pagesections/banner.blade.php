    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="banner-text col col-12 col-lg-6">
                <h1>Choose the <span class="col-brand-1">Right Hospital<br></span>for <span class="col-brand-1">Your&nbsp;Treatment</span></h1>
...
@if(empty($hideText))
    <section class="mobile-choice d-lg-none text-center p-y-75">
        <div class="container">
            <div class="row">
                <div class="banner-text col col-12 col-lg-6">
                    <h2 class="h1">You have a <span class="col-brand-1">choice</span></h2>
