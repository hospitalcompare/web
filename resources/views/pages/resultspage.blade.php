        ...
        <section class="filter">
            <form class="formElem">
                ...
                <div class="selectProx">
                    <div class="postProxChild">
                        @include('components.basic.selectbox', ['options' => $data['procedures'], 'chevronFAClassName' => 'fa-chevron-down blackChevron', 'selectClass' => 'searchPageSelect', 'placeholder'=>'Choose your procedure', 'name'=>'procedure_id', 'resultsLabel' => 'resultsLabel'])
...
{{--                    @include('components.basic.selectbox', ['options' => [['id'=>1, 'name'=>'Distance from postcode'], ['id'=>2, 'name'=>'Distance from postcode']], 'selectClass' => 'sortBy', 'chevronFAClassName' => 'fa-chevron-down blackChevron', 'placeholder' => 'Sort by:', 'resultsLabel' => 'sortLabel'])--}}
                    @include('components.basic.selectbox', ['options' => $data['procedures'], 'chevronFAClassName' => 'fa-chevron-down blackChevron', 'selectClass' => 'searchPageSelect', 'placeholder'=>'Sort by:', 'name'=>'procedure_id', 'resultsLabel' => 'sortLabel'])
