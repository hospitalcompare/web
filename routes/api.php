...
Route::middleware('checkToken')->group(function () {
    ...
    Route::get('/getHospitalsForHomepageSearch/{procedureId}/{postcode}', 'ApiController@getHospitalsForHomepageSearch'); // Given a procedure id, return the parent specialty
