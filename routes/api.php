...
Route::middleware('checkToken')->group(function () {
    ...
    Route::get('/getHospitalsForHomepageSearch/{postcode}/{procedureId}', 'ApiController@getHospitalsForHomepageSearch'); // Given a procedure id, return the parent specialty
